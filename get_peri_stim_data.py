...
def get_peri_stim_data(output_dir, session_id):
    ...
    np.save(variables_dir / 'rank_snippets.npy', rank_snippets)
    ...
    save_npz(variables_dir / 'active_mask_snippet_sparse.npz', sparse_mask)
    np.save(variables_dir / 'active_mask_shape.npy', orig_shape)
